...
export default function AdminHeader({ onToggleSidebar }: AdminHeaderProps) {
  ...
  return (
    <header className="h-[65px] bg-white px-6 flex items-center justify-between shadow-xs border-b border-[#ebedf2] z-20 shrink-0">
      <div className="flex items-center gap-6">
        ...
        <button
          ...
          className="text-[#6c757d] hover:text-[#343a40] focus:outline-none p-1 cursor-pointer"
